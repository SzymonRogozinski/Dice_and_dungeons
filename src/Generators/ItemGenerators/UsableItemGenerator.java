...
public class UsableItemGenerator {
    ...
    private static final UsableItem[] COMMONS = new UsableItem[]{
            ...
            new UsableItem(new UsableItemAction(ActionTarget.PLAYER_CHARACTER, new ArrayList<>(List.of(new DiceAction[]{new DefenseBonusAction(1, true)})), new Tags[]{Tags.NO_ROLL, Tags.FREE_ACTION}), 1, new Tags[]{}, new ImageIcon("Texture/Items/usable_item/defense_potion.png"), "defense potion", "def. potion", ItemQuality.COMMON),
    ...
    private static final UsableItem[] RARES = new UsableItem[]{
            ...
            new UsableItem(new UsableItemAction(ActionTarget.PLAYER_CHARACTER, new ArrayList<>(List.of(new DiceAction[]{new DefenseBonusAction(2, true)})), new Tags[]{Tags.NO_ROLL, Tags.FREE_ACTION}), 1, new Tags[]{}, new ImageIcon("Texture/Items/usable_item/defense_potion.png"), "better defense potion", "def. potion", ItemQuality.RARE),
    ...
    private static final UsableItem[] LEGENDS = new UsableItem[]{
            ...
            new UsableItem(new UsableItemAction(ActionTarget.PLAYER_CHARACTER, new ArrayList<>(List.of(new DiceAction[]{new DefenseBonusAction(3, true)})), new Tags[]{Tags.NO_ROLL, Tags.FREE_ACTION}), 1, new Tags[]{}, new ImageIcon("Texture/Items/usable_item/defense_potion.png"), "the best defense potion", "def. potion", ItemQuality.LEGENDARY),
