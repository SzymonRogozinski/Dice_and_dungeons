...
public class DiceItemFrames {
    ...
    private final static DiceItemFrame[] DICE_ITEM_FRAMES = new DiceItemFrame[]{
            ...
            new DiceItemFrame(new double[]{0, 0, 0.2, 0.2, 0.2, 0.4}, ActionEnum.COUNTER_ACTION, new String[]{"sword breaker"}, ActionTarget.PLAYER_CHARACTER, new int[]{}, p -> p.getDiceNumber(p.getCharisma()), false, new ImageIcon("Texture/Items/attack_item/sword_breaker.png"), "charisma"),
