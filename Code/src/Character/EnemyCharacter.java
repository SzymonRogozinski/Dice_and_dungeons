...
import com.company.Walking.Collision.EnemyKilledException;
import com.company.Walking.Collision.EnterExitException;
import com.company.Walking.GameMap;
import com.company.Walking.Places.GamePlace;
import com.company.Walking.Places.PlayerGamePlace;
import com.company.Walking.Places.SpaceGamePlace;
...
public class EnemyCharacter extends GameCharacter
{
    ...
    public EnemyCharacter(int posX, int posY, GamePlace icon,GamePlace pursuitIcon) {
