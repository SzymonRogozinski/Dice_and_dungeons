...
public class GameConst {
    ...
    private static final ActionItem shield = new ActionItem(new ItemAction(DiceFactory.buildDice(new int[][]{{0},{2,4,0},{2,4,0},{2,4,0},{2,4,0},{2,4,0}}), ActionTarget.PLAYER_CHARACTER,(PlayerCharacter p)->p.getDiceNumber(p.getEndurance()),new Tags[]{Tags.DEFENCE}), new Tags[]{},new ImageIcon("Texture/Items/attack_item/shield.png"),"shield","shield",ItemQuality.COMMON, "endurance");
    private static final ActionItem trap = new ActionItem(new ItemAction(DiceFactory.buildDice(new int[][]{{0},{0},{0},{6,1},{6,1},{6,2}}), ActionTarget.ENEMY_CHARACTER,(PlayerCharacter p)->p.getDiceNumber(p.getCunning()), new Tags[]{}),new Tags[]{},new ImageIcon("Texture/Items/attack_item/trap.png"),"trap","trap",ItemQuality.COMMON, "cunning");
    private static final ActionItem bolas = new ActionItem(new ItemAction(DiceFactory.buildDice(new int[][]{{0},{0},{7,1},{7,1},{7,1},{7,2}}), ActionTarget.ENEMY_CHARACTER,(PlayerCharacter p)->p.getDiceNumber(p.getCunning()), new Tags[]{}),new Tags[]{},new ImageIcon("Texture/Items/attack_item/bolas.png"),"bolas","bolas",ItemQuality.COMMON,"cunning");
    private static final ActionItem magic_sphere = new ActionItem(new ItemAction(DiceFactory.buildDice(new int[][]{{0},{4,4},{4,4},{4,4},{4,4},{4,4}}), ActionTarget.PLAYER_CHARACTER,(PlayerCharacter p)->p.getDiceNumber(p.getIntelligence()), new Tags[]{}),new Tags[]{},new ImageIcon("Texture/Items/attack_item/magic_sphere.png"),"magic sphere","magic sphere",ItemQuality.COMMON,"intelligence");
