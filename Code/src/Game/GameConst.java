...
public class GameConst {
    private static final ActionItem sword = new ActionItem(new ItemAction(DiceFactory.buildDice(new int[][]{{0},{0},{1,4},{1,4},{1,6},{1,6}}), ActionTarget.ENEMY_CHARACTER,(PlayerCharacter p)->p.getDiceNumber(p.getStrength()),new Tags[]{Tags.ATTACK}), new Tags[]{},new ImageIcon("Texture/Items/attack_item/sword.png"),"sword", ItemQuality.COMMON);
    private static final ActionItem bow = new ActionItem(new ItemAction(DiceFactory.buildDice(new int[][]{{0},{1,2},{1,3},{1,3},{1,6},{1,6}}), ActionTarget.ENEMY_CHARACTER,(PlayerCharacter p)->p.getDiceNumber(p.getStrength()),new Tags[]{Tags.ATTACK}), new Tags[]{},new ImageIcon("Texture/Items/attack_item/bow.png"),"bow", ItemQuality.COMMON);
    private static final ActionItem shield = new ActionItem(new ItemAction(DiceFactory.buildDice(new int[][]{{0},{2,4,0},{2,4,0},{2,4,0},{2,4,0},{2,4,0}}), ActionTarget.PLAYER_CHARACTER,(PlayerCharacter p)->p.getDiceNumber(p.getEndurance()),new Tags[]{Tags.DEFENCE}), new Tags[]{},new ImageIcon("Texture/Items/attack_item/shield.png"),"shield",ItemQuality.COMMON);
    private static final ActionItem trap = new ActionItem(new ItemAction(DiceFactory.buildDice(new int[][]{{0},{0},{0},{6,1},{6,1},{6,2}}), ActionTarget.ENEMY_CHARACTER,(PlayerCharacter p)->p.getDiceNumber(p.getCunning()), new Tags[]{}),new Tags[]{},new ImageIcon("Texture/Items/attack_item/trap.png"),"trap",ItemQuality.COMMON);
    private static final ActionItem bolas = new ActionItem(new ItemAction(DiceFactory.buildDice(new int[][]{{0},{0},{7,1},{7,1},{7,1},{7,2}}), ActionTarget.ENEMY_CHARACTER,(PlayerCharacter p)->p.getDiceNumber(p.getCunning()), new Tags[]{}),new Tags[]{},new ImageIcon("Texture/Items/attack_item/bolas.png"),"bolas",ItemQuality.COMMON);
    private static final ActionItem magic_sphere = new ActionItem(new ItemAction(DiceFactory.buildDice(new int[][]{{0},{4,4},{4,4},{4,4},{4,4},{4,4}}), ActionTarget.PLAYER_CHARACTER,(PlayerCharacter p)->p.getDiceNumber(p.getIntelligence()), new Tags[]{}),new Tags[]{},new ImageIcon("Texture/Items/attack_item/magic_sphere.png"),"magic sphere",ItemQuality.COMMON);
    private static final SpellItem ghost_sword = new SpellItem(new SpellAction(DiceFactory.buildDice(new int[][]{{0},{8,2,1},{8,2,1},{8,2,1},{8,4,1},{8,4,1}}), ActionTarget.PLAYER_CHARACTER,(PlayerCharacter p)->p.getDiceNumber(p.getIntelligence()),17,new Tags[]{Tags.MAGIC}), new Tags[]{},new ImageIcon("Texture/Items/spells/ghost_sword.png"),"ghost sword",ItemQuality.COMMON);
    private static final SpellItem thunder_ball = new SpellItem(new SpellAction(DiceFactory.buildDice(new int[][]{{0},{0},{0},{1,5},{1,11},{1,11}}), ActionTarget.ENEMY_CHARACTER,(PlayerCharacter p)->p.getDiceNumber(p.getIntelligence()),16,new Tags[]{Tags.MAGIC}), new Tags[]{},new ImageIcon("Texture/Items/spells/thunder_ball.png"),"thunder ball",ItemQuality.COMMON);
    private static final SpellItem toxic_flower = new SpellItem(new SpellAction(DiceFactory.buildDice(new int[][]{{0},{0},{0},{5,3},{5,3},{5,3}}), ActionTarget.PLAYER_CHARACTER,(PlayerCharacter p)->p.getDiceNumber(p.getIntelligence()),16,new Tags[]{Tags.MAGIC}), new Tags[]{},new ImageIcon("Texture/Items/spells/toxic_flower.png"),"toxic flower",ItemQuality.COMMON);
