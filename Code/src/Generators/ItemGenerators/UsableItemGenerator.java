...
public class UsableItemGenerator {
    ...
    private static final UsableItem[] COMMONS = new UsableItem[]{
            ...
            new UsableItem(new UsableItemAction(ActionTarget.PLAYER_CHARACTER,new ArrayList<>(List.of(new DiceAction[]{new DefenseBonusAction(1,true)})),new Tags[]{Tags.NO_ROLL,Tags.FREE_ACTION}),1,new Tags[]{},new ImageIcon("Texture/Items/defense_potion.png"),"defense potion",ItemQuality.COMMON),
            new UsableItem(new UsableItemAction(ActionTarget.PLAYER_CHARACTER,new ArrayList<>(List.of(new DiceAction[]{new MagicBonusAction(1,true)})),new Tags[]{Tags.NO_ROLL,Tags.FREE_ACTION}),1,new Tags[]{},new ImageIcon("Texture/Items/magic_powder.png"),"magic powder",ItemQuality.COMMON)
    };
    ...
    private static final UsableItem[] RARES = new UsableItem[]{
            ...
            new UsableItem(new UsableItemAction(ActionTarget.PLAYER_CHARACTER,new ArrayList<>(List.of(new DiceAction[]{new DefenseBonusAction(2,true)})),new Tags[]{Tags.NO_ROLL,Tags.FREE_ACTION}),1,new Tags[]{},new ImageIcon("Texture/Items/defense_potion.png"),"better defense potion",ItemQuality.RARE),
            new UsableItem(new UsableItemAction(ActionTarget.PLAYER_CHARACTER,new ArrayList<>(List.of(new DiceAction[]{new MagicBonusAction(2,true)})),new Tags[]{Tags.NO_ROLL,Tags.FREE_ACTION}),1,new Tags[]{},new ImageIcon("Texture/Items/magic_powder.png"),"ancient magic powder",ItemQuality.RARE)
    };
    ...
    private static final UsableItem[] LEGENDS = new UsableItem[]{
            ...
            new UsableItem(new UsableItemAction(ActionTarget.PLAYER_CHARACTER,new ArrayList<>(List.of(new DiceAction[]{new DefenseBonusAction(3,true)})),new Tags[]{Tags.NO_ROLL,Tags.FREE_ACTION}),1,new Tags[]{},new ImageIcon("Texture/Items/defense_potion.png"),"the best defense potion",ItemQuality.LEGENDARY),
            new UsableItem(new UsableItemAction(ActionTarget.PLAYER_CHARACTER,new ArrayList<>(List.of(new DiceAction[]{new MagicBonusAction(3,true)})),new Tags[]{Tags.NO_ROLL,Tags.FREE_ACTION}),1,new Tags[]{},new ImageIcon("Texture/Items/magic_powder.png"),"eldritch magic powder",ItemQuality.LEGENDARY)
    };
