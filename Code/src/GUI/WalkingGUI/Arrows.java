...
public class Arrows extends JPanel {
    public Arrows(Border border) {
        ...
        up.addActionListener(e -> GameCollection.getWalkingManager().getWalking().playerMove(0, -1));
        ...
        left.addActionListener(e -> GameCollection.getWalkingManager().getWalking().playerMove(-1, 0));
        ...
        right.addActionListener(e -> GameCollection.getWalkingManager().getWalking().playerMove(1, 0));
        ...
        down.addActionListener(e -> GameCollection.getWalkingManager().getWalking().playerMove(0, 1));
